      ...
      <template v-else-if="order">
        ...
        >
          ...
          <div
            ...
            class="px-6 sm:px-8 pt-2 pb-4 border-b-2 border-[#E8D9C9]"
          >
            <div
              class="text-xs font-black text-[#D96C2C] uppercase tracking-wider mb-4 flex items-center gap-1.5"
            >
            ...
            <div class="grid grid-cols-4 gap-2 text-center relative">
              ...
              <div class="flex flex-col items-center space-y-1.5 relative z-10">
                ...
                <span
                  ...
                  :class="currentStepIndex >= 1 ? 'text-[#D96C2C]' : 'text-[#786B62]'"
                  >สั่งซื้อสินค้า</span
                >
              </div>
              ...
              <div class="flex flex-col items-center space-y-1.5 relative z-10">
                <div
                  ...
                  :class="
                    currentStepIndex >= 2
                      ? 'bg-[#D96C2C] text-white shadow-md'
                      : 'bg-[#F7F0E6] text-[#786B62] border border-[#E8D9C9]'
                  "
                >
                ...
                <span
                  class="text-[11px] font-black"
                  :class="currentStepIndex >= 2 ? 'text-[#D96C2C]' : 'text-[#786B62]'"
                  >ชำระเงินแล้ว</span
                >
              </div>
              ...
              <div class="flex flex-col items-center space-y-1.5 relative z-10">
                ...
                <span
                  class="text-[11px] font-black"
                  :class="currentStepIndex >= 3 ? 'text-[#D96C2C]' : 'text-[#786B62]'"
                  >จัดส่งสินค้า</span
                >
              </div>
              ...
              <div class="flex flex-col items-center space-y-1.5 relative z-10">
                ...
                <span
                  class="text-[11px] font-black"
                  :class="currentStepIndex >= 4 ? 'text-emerald-700' : 'text-[#786B62]'"
                  >สำเร็จสมบูรณ์</span
                >
              </div>
            </div>
          ...
          <div class="p-6 sm:p-8 space-y-6">
            ...
            >
              ...
              <p class="font-bold">
                ผู้ให้บริการ: {{ order.shipment.shippingProvider || 'Flash Express' }}
              </p>
              <p class="font-mono font-black text-base text-[#D96C2C]">
                หมายเลขพัสดุ: {{ order.shipment.trackingNumber || 'TH2024889102' }}
              </p>
            ...
            <div class="border-t-2 border-[#E8D9C9] pt-6 space-y-3 text-sm font-semibold">
              <div class="flex justify-between text-[#786B62]">
                ...
                <span class="font-black text-[#332820]"
                  >฿ {{ Number(order.subtotal).toLocaleString('th-TH') }}</span
                >
              </div>
              <div class="flex justify-between text-[#786B62]">
                <span>ค่าจัดส่ง</span>
                <span class="font-black text-[#332820]"
                  >฿ {{ Number(order.shippingFee).toLocaleString('th-TH') }}</span
                >
              </div>
              <div
              ...
              >
                ...
                <span class="text-2xl text-[#D96C2C]"
                  >฿ {{ Number(order.totalAmount).toLocaleString('th-TH') }}</span
                >
              </div>
            </div>
