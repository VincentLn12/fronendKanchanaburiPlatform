...
<template><div ref="element" class="relative isolate z-0 h-80 overflow-hidden rounded-2xl" /></template>

<style scoped>
:deep(.content-location-marker) {
  display: flex;
  align-items: center;
  ...
  background: #059669;
  color: white;
  box-shadow: 0 4px 12px rgb(5 150 105 / 0.35);
}
:deep(.content-location-marker i) {
  transform: rotate(45deg);
  font-size: 23px;
}
