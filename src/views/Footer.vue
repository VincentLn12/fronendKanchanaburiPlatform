<!-- Footer -->
<template>
  <footer class="relative z-10 bg-[#171412] text-[#F7F0E6]/80 pt-14 pb-8 overflow-hidden border-t-2 border-[#D96C2C]">
    <!-- Subtle Ambient Gradient Background -->
    <div class="absolute inset-0 pointer-events-none opacity-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#D96C2C] via-transparent to-transparent"></div>

    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
      <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-12 pb-12 border-b border-white/10">
        <!-- Col 1: About Project -->
        <div class="lg:col-span-4 space-y-4">
          <div class="flex items-center gap-3">
            <div class="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#D96C2C] text-white font-bold shadow-md">
            ...
            <div class="flex flex-col">
              ...
              <span class="text-[11px] font-bold text-[#F2A65A]">แพลตฟอร์มท่องเที่ยวเชิงวัฒนธรรม</span>
            </div>
          </div>
          ...
          <div class="flex items-center gap-2 pt-2">
            <a href="#" class="flex h-9 w-9 items-center justify-center rounded-xl bg-white/10 text-[#F7F0E6] hover:bg-[#D96C2C] hover:text-white transition shadow-2xs border border-white/10">
        ...
        <div class="lg:col-span-2 space-y-3">
          ...
          <ul class="space-y-2.5 text-xs sm:text-sm font-bold">
            ...
            <li>
              <RouterLink to="/contents" class="hover:text-[#D96C2C] transition-colors">คอนเทนต์</RouterLink>
            </li>
            <li>
              <RouterLink to="/shops" class="hover:text-[#D96C2C] transition-colors">ร้านค้า</RouterLink>
            </li>
            <li>
              <RouterLink to="/cart" class="hover:text-[#D96C2C] transition-colors">ตะกร้าสินค้า</RouterLink>
            </li>
          </ul>
        </div>
        ...
        <div class="lg:col-span-3 space-y-3">
          ...
          <ul class="space-y-2.5 text-xs sm:text-sm font-bold">
            ...
            <li>
              <a href="#" class="hover:text-[#D89216] transition-colors">คู่มือการซื้อสินค้า</a>
            </li>
            <li>
              <a href="#" class="hover:text-[#D96C2C] transition-colors">ติดต่อสอบถาม</a>
            </li>
            <li>
              <a href="#" class="hover:text-[#D96C2C] transition-colors">แจ้งปัญหาการใช้งาน</a>
            </li>
          </ul>
        </div>
      ...
      <!-- Bottom Bar -->
      <div class="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-[#F7F0E6]/60 gap-3 font-semibold">
